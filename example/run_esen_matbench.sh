...
OPT4_EXECUTION_SCOPE=${OPT4_EXECUTION_SCOPE:-whole-step}
OPT4_NEIGHBOR_BUILDER=${OPT4_NEIGHBOR_BUILDER:-dense}
OPT4_NEIGHBOR_CAPACITY_POLICY=${OPT4_NEIGHBOR_CAPACITY_POLICY:-auto-safe}
CELL_LIST_BIN_CAPACITY=${CELL_LIST_BIN_CAPACITY:-0}
CELL_LIST_BIN_MARGIN=${CELL_LIST_BIN_MARGIN:-0.25}
CELL_LIST_BIN_STEP=${CELL_LIST_BIN_STEP:-8}
...
args=(
    ...
    --opt4-execution-scope "$OPT4_EXECUTION_SCOPE"
    --opt4-neighbor-builder "$OPT4_NEIGHBOR_BUILDER"
    --opt4-neighbor-capacity-policy "$OPT4_NEIGHBOR_CAPACITY_POLICY"
    --cell-list-bin-capacity "$CELL_LIST_BIN_CAPACITY"
    --cell-list-bin-margin "$CELL_LIST_BIN_MARGIN"
    --cell-list-bin-step "$CELL_LIST_BIN_STEP"
