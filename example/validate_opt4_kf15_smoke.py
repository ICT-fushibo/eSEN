#!/usr/bin/env python3
"""Validate compile, replacement and graph metadata from KF15 smoke."""
...
def main() -> int:
    ...
    if failures:
        raise SystemExit("KF15 smoke failed:\n" + "\n".join(failures))
    print(f"KF15 smoke passed: {len(records)} candidate results")
    return 0
