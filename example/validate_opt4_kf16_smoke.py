#!/usr/bin/env python3
"""Validate replacement and CUDA Graph metadata from KF16 smoke."""
...
def main() -> int:
    ...
    if failures:
        raise SystemExit("KF16 smoke failed:\n" + "\n".join(failures))
    print(f"KF16 smoke passed: {len(records)} candidate results")
    return 0
